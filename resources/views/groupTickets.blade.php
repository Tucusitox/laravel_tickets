...
@section('Laravel', 'Tickets grupos')
...
@php
    ...
    $Tickets = UsersProjectsRequest::join('requests', 'requests.id_request', '=', 'users_projects_request.fk_request')
        ...
        ->join('users', 'users.user_id', '=', 'users_projects_request.fk_user')
        ->join('groups', 'groups.id_group', '=', 'users.fk_group')
                ...
                <div class="card-header py-3">
                    <div class="card-tools row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-6 my-2">
                            <h4 class="card-title"><b>Tickets asignados a mi grupo -> {{ $Tickets->count() }}</b></h4>
                        </div>
